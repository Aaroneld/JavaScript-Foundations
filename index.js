...
function mortgageCalculator(principal, rate, years, name, creditScore){
    ...
    if(creditScore > 740) internalRate -= .005 ;
    else if(creditScore < 660) internalRate += .005;

    let monthlyInterestRate = internalRate/12;
    let periods = years*12;
...
console.log(mortgageCalculator(principal, interestRate, years, "Aaron"));
...
console.log(mortgageCalculator(200000, .05, 30, "Aaron", 670));
...
function variableInterestRate(principal, rate, years, name){
    ...
    for(i = 0; i < 9; i++ ){
        ...
        let ROUNDED = Math.round(MONTHLY_RATE);
...
variableInterestRate(200000, .04, 30, "Aaron");
